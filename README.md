...
local Window = OrionLib:MakeWindow({Name = "exility HUB", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "exility HUB"})

OrionLib:MakeNotification({
	Name = "exility HUB",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://90927390200115",
	Time = 7
})
...
local W = Window:MakeTab({
    Name = "Welcome",
    Icon = "rbxassetid://90927390200115",
    PremiumOnly = false
})
...
W:AddLabel("[+] exility HUB is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "exility HUB(Noitification)",
